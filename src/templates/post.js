    ...
    <div ref={container} className="container">
      ...
      <div className="contentContainer">
        <div className="postContent">
          ...
          >
            <svg className="audioIcon" viewdiv="0 0 22 18">
          ...
          <div className="ratings">
            <div>
              <div
                style={{ fontSize: 15, fontWeight: 600, marginRight: "10px" }}
                component="strong"
              >
                Overall ratings
              </div>
            ...
            return (
              <Link key={post.slug} to={`/${post.slug}`}>
                <div className="appContainer">
                  ...
                  <div>
                    <div
                      style={{ fontSize: 16, lineHeight: "20px", fontWeight: 600 }}
                    >
                      {post.title}
                    </div>
